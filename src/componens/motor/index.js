...
import menu from "../../assets/images/homepage/11 1.png"
import { Umumiy } from '../../componens/Styles/style';
import { Link } from 'react-router-dom';
import { campcar } from '../mock/motor';
import { CardWrapper, ComName, Company, Container, Menu, Name, Narx, Order } from '../motor/style';
...
<h4 className='Home'>Home / Motors</h4>
       <h2 className='Ranges'>Our ranges</h2>
       <h1 className='Page'>Motors</h1>
</div>
