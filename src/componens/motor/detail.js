...
import { AddBtn, ButtonDiv, Comfort, CompareBtn, CompareBtn1, DetailOboy, DetaImg, DetaMobile, DetaRight, DetaRight1, DetaTop, Gap, InfoCost, InfoName, OboyCom, SmallInfo, SmallInfoRight, TogriChiziq, Word } from './style';
...
<div style={{display: `flex`,flexDirection: `column`, alignItems:`center`, justifyContent: `center`, }}>
    ...
    <DetaMobile className='detaMobile' style={{display: `flex`, paddingTop: `50px`, gap: `150px`}}> <DetaTop>
         ...
         <DetaRight>
         <Gap style={{display: `flex`, justifyContent:`space-between`}}>     <InfoName>{valeu.car.company}</InfoName><InfoCost>{valeu.car.cost}</InfoCost>       </Gap> 
         <div>aid</div>
