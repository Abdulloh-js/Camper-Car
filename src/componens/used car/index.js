...
import { campcar } from '../mock/used';
import { CardWrapper, ComName, Company, Container, Name, Narx, Order } from '../motor/style';
import HmenuUsed from './hmenu';
import VmenuUsed from './vmenu';
...
<div className="motors4">
<h4 className='Home'>Home / Used Car</h4>
       <h2 className='Ranges'>Our ranges</h2>
       <h1 className='Page'>Used Car</h1>
</div>
...
<div className="button">
   ...
   <div className="compare">
           ...
           <div >
            ...
            {active ? <HmenuUsed /> : <VmenuUsed />}
      {/* <Container>
      {
        data.map((value, index)=>{
return(
<div key={index}>
    <Link className="Link" to={`/used-car/${value.id}`}>
      <CardWrapper> 
