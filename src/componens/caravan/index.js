...
import VmenuCaravan from './vmenuCaravan';
...
<div className="motors2">
<h4 className='Home'>Home / Caravan</h4>
       <h2 className='Ranges'>Our ranges</h2>
       <h1 className='Page'>Caravan</h1>
</div>
...
<div className="button">
   ...
   <div className="compare">
           ...
           {active ? <HmenuCaravan /> : <VmenuCaravan />}
      {/* <Container>
      {
